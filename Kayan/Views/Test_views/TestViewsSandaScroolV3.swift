//
//  TestViewsSandaScroolV2.swift
//  Kayan
//
//  Created by Sandal on 10/11/1442 AH.
//

import SwiftUI
import SwiftyJSON
struct TestViewsSandaScroolV3: View {
    @State var id:Int=0
...
//        withAnimation(.easeIn(duration: 0.5)) {//1.5
            ...
            BackagePosition[CardIndecator+1] = 0
            BackageHight[CardIndecator] =   UIScreen.screenHeight*0.5
//        }
        for i in CardIndecator+1...stories.count-1{
...
//        }
        ...
        for i in CardIndecator+1...stories.count-1{
                   BackagePosition[i] = -BackagePosition[CardIndecator+1]-(UIScreen.screenWidth*0.4)-50
